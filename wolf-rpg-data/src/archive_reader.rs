...
#[derive(Debug)]
struct CompressedFileReaderInner {
    file_data: std::io::Cursor<Vec<u8>>,
}
...
fn decompress_file_data(mut input: &[u8], size: u64) -> Option<Vec<u8>> {
